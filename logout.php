...
// Ici tu peux ajouter ta logique de déconnexion, par exemple:
// session_destroy(); ou autre action si c’est une page logout
?>
...
<head>
  ...
  <style>
    ...
    /* Image de fond en position fixe */
    .background-image {
      position: fixed; 
      top: 0; 
      left: 0; 
